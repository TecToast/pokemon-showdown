...
const EXISTENCE_TAGS = ['past', 'future', 'lgpe', 'unobtainable', 'cap', 'batzi', 'dml', 'mnm', 'htcyd', 'custom', 'nonexistent'];
// ['past', 'future', 'lgpe', 'unobtainable', 'cap', 'batzi', 'dml', 'mnm', 'htcyd', 'custom', 'nonexistent'];
